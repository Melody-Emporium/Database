...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `calculate_product_rating` AFTER INSERT ON `client_ratings` FOR EACH ROW BEGIN
...
-- Dump completed on 2024-03-04 18:50:13
